     ...
     <div class="container text-center" >
      ...
      <table class="table text-center table-bordered table-hover">
         ...
         $Resultans = 0;
        	...
        	<td>
            <?php
                echo "Out of 2, You have attempt ".$checked_count." option."; ?>
            </td>
            ...
            $finalresult = " insert into user1(username,tques,answerscorrect) values ('$name','2','$Resultans') ";
